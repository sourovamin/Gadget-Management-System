...
margin-right:auto;
	...
	First Name <br><input type="text" name="first" value="<?php echo $row['first_name']?>" size="40"><br>
	Last Name <br><input type="text" name="user" value="<?php echo $row['last_name']?>" size="40"><br>
 ...
 New password <br><input type="password" name="newpass" size="40"><br><br>
    <input id="button" type="submit" name="submit" value="UPDATE">
			...
			mysql_query("update admin set user='$user',`email`='$email',pass='$newpass',first_name='$first',last_name='$last' where `pass` ='$pass' and id='$id'");
		if($dpass['pass']==$pass)
		 {
			//header("location:index.php?logout");
			echo 'Account Update Successful!';
		}
		else echo 'Account Update Failed';
	}
		?>
